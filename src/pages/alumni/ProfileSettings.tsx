...
import { 
  User, Mail, Lock, Bell, Shield, Camera, Save, Briefcase, GraduationCap, Globe, ChevronRight, ExternalLink 
} from 'lucide-react';
                      ...
                      <div className="flex flex-col items-center gap-8 sm:flex-row">
                        <div className="relative group">
                          <div className="h-28 w-28 overflow-hidden rounded-[2rem] ring-4 ring-slate-50 shadow-inner">
                            <img src="https://picsum.photos/seed/alumni/200/200" alt="Avatar" className="h-full w-full object-cover" referrerPolicy="no-referrer" />
                          </div>
                      ...
                      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input type="number" value={formData.graduationYear} onChange={(e) => setFormData({...formData, graduationYear: e.target.value})} className="w-full rounded-2xl border-transparent bg-slate-50 py-3.5 pr-4 pl-12 text-sm font-medium ring-1 ring-slate-100 placeholder:text-slate-400 focus:border-transparent focus:bg-white focus:ring-2 focus:ring-indigo-500/50 transition-all shadow-sm" />
                          </div>
                        </div>
                      </div>
                    </section>
                    ...
                    <section className="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-200">
                      ...
                      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                          ...
                          <input type="text" value={formData.company} onChange={(e) => setFormData({...formData, company: e.target.value})} placeholder="e.g. Google" className="w-full rounded-2xl border-transparent bg-slate-50 py-3.5 px-4 text-sm font-medium ring-1 ring-slate-100 placeholder:text-slate-400 focus:border-transparent focus:bg-white focus:ring-2 focus:ring-indigo-500/50 transition-all shadow-sm" />
                        </div>
                        <div className="sm:col-span-2">
                          <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 ml-1">Expertise & Skills</label>
                          <input type="text" value={formData.expertise} onChange={(e) => setFormData({...formData, expertise: e.target.value})} placeholder="e.g. AI, Machine Learning, Python" className="w-full rounded-2xl border-transparent bg-slate-50 py-3.5 px-4 text-sm font-medium ring-1 ring-slate-100 placeholder:text-slate-400 focus:border-transparent focus:bg-white focus:ring-2 focus:ring-indigo-500/50 transition-all shadow-sm" />
                        </div>
                        <div className="sm:col-span-2">
                          <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 ml-1">Mentor Bio</label>
                          <textarea rows={4} value={formData.bio} onChange={(e) => setFormData({...formData, bio: e.target.value})} className="w-full rounded-2xl border-transparent bg-slate-50 py-3.5 px-4 text-sm font-medium ring-1 ring-slate-100 placeholder:text-slate-400 focus:border-transparent focus:bg-white focus:ring-2 focus:ring-indigo-500/50 transition-all shadow-sm" placeholder="Share your professional journey..."></textarea>
                        </div>
                      </div>
                    </section>
                  </div>
