          ...
          <div className="flex-1 overflow-y-auto px-2">
            ...
            {chats.length === 0 && (
              <p className="px-4 py-6 text-center text-xs text-slate-400">
                No conversations yet. Connect with a mentor to start chatting.
              </p>
            )}
            {chats.map((chat) => (
              <button
          ...
          {selectedChat ? (
            <>
              ...
              <header className="flex items-center justify-between border-b border-slate-100 bg-white px-6 py-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-bold text-slate-900">{selectedChat.alumniName}</p>
                    <p className="text-[10px] text-slate-500 font-medium">Mentor</p>
                  </div>
                </div>
            ...
            <div className="flex flex-1 items-center justify-center text-center">
              <div>
                ...
                <p className="text-sm text-slate-400">Choose a mentor from the list to start chatting.</p>
              </div>
            </div>
          )}
        </main>
