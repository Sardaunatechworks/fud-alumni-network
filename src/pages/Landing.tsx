      ...
      <nav className="fixed top-0 z-50 w-full border-b border-slate-100 bg-white/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold tracking-tight text-indigo-900">FUD Alumni</span>
          </div>
          <div className="flex items-center gap-4">
            <Link to="/login" className="text-sm font-medium text-slate-600 hover:text-indigo-900">
              Login
            </Link>
            <Link 
              to="/signup/student" 
              className="rounded-full bg-indigo-900 px-5 py-2 text-sm font-semibold text-white transition-all hover:bg-indigo-800 hover:shadow-lg"
            >
              Get Started
            </Link>
          </div>
            ...
            <div className="lg:col-span-7">
              ...
              >
                ...
                <h1 className="mt-6 text-5xl font-extrabold tracking-tight text-slate-900 sm:text-6xl lg:text-7xl">
                  Connect with FUD <span className="text-indigo-900">Excellence.</span>
                </h1>
                ...
                <div className="mt-10 flex flex-col gap-4 sm:flex-row">
                  <Link
                    to="/signup/student"
                    className="flex items-center justify-center gap-2 rounded-xl bg-indigo-900 px-8 py-4 text-lg font-bold text-white transition-all hover:bg-indigo-800 hover:shadow-xl"
                  >
                    Sign Up as Student <ArrowRight size={20} />
                  </Link>
                  <Link
                    to="/signup/alumni"
                    className="flex items-center justify-center gap-2 rounded-xl border-2 border-slate-200 bg-white px-8 py-4 text-lg font-bold text-slate-700 transition-all hover:border-indigo-900 hover:text-indigo-900"
                  >
                    Sign Up as Alumni
                  </Link>
                </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div key={i} className="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-slate-200 transition-all hover:shadow-md">
      ...
      <footer className="border-t border-slate-200 bg-white py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
            <div className="flex items-center gap-2">
              <GraduationCap size={24} className="text-indigo-900" />
              <span className="text-lg font-bold tracking-tight text-indigo-900">FUD Alumni</span>
            </div>
